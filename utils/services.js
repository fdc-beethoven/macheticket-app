...
module.exports = {
  updateSlackThreadUrl: async function (issueKey, slackUrl) {
    let payload = {
      fields: {
  ...
  fetchJiraIssue: async function (issueKey) {
  ...
  getJiraComponents: async function () {
    let url =
      "https://native-camp.atlassian.net/rest/api/2/project/MCT/components";
  ...
  updateJiraSubtasks: async function (issueKey, action_item, platform_array, deadline) {
